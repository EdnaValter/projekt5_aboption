var grocery_list = [
    ...
    {name:"Æg", question:'Hvilken form har æg?', choices:["Aflang", "Firkant", "Cirkel"], Rewards:["et monsterkort", "prinsesse kort", "peter pedal kort"], right_choice:"Aflang"},
    {name:"Mælk", question:'Hvad hedder Koens babyer?', choices:["Ko", "Kalv", "Føl"], Rewards:["et kort", "et kort", "et kort"], right_choice:"Kalv"},
